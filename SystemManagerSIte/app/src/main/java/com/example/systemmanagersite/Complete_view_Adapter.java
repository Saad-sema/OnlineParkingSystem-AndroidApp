...
public class Complete_view_Adapter extends BaseAdapter {
    Context context;
    List<view_ConfRes_data> bookingList;
    public Complete_view_Adapter(Context context, List<view_ConfRes_data> bookingList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.comple_view_layout, parent, false);
        }
        ...
        btnConfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                checkOTP checkotp = new checkOTP(context,booking.getOTP(),booking.getBookingId(),"give_complete");
            }
        });
