...
public class Extend_Duration_Adapter extends BaseAdapter {
    Context context;
    List<view_ConfRes_data> bookingList;
    view_ConfRes_data booking;
    long[] totalPrice = {50};
    int ExtraCharge;

    public Extend_Duration_Adapter(Context context, List<view_ConfRes_data> bookingList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.extend_duration_layout, parent, false);
        }
    ...
    private void showExtendOptionsDialog(String currentEndTimeStr, String slotId, String bookingId) {
        ...
        View view = inflater.inflate(R.layout.dialog_extend_options, null);
                ...
                response -> {
                    ...
                    try {
                        ...
                        if (status.equals("available")) {
                            ...
                            Intent intent = new Intent(context, manager_extend_free_slots.class);
