...
public class Manager_CompleteBooking extends AppCompatActivity {
    ListView listView;
    Complete_view_Adapter adapter;
    private List<view_ConfRes_data> confirmResSlots =new ArrayList<>();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_manager_complete_booking);
        listView = findViewById(R.id.listView);
        ImageView btnBack = findViewById(R.id.btnBack);
        ImageView btnRef=findViewById(R.id.btnRefres);

        adapter= new Complete_view_Adapter(this, confirmResSlots);
    ...
    private void fetchCompleteBooking() {
        String base_url=getString(R.string.url);
        String url = base_url+"/parking_system/view_complete.php";
