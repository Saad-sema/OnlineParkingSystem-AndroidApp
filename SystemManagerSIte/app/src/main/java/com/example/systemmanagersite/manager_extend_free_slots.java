...
public class manager_extend_free_slots extends AppCompatActivity {
    ListView listView;
    extend_free_slot_adapter adapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_manager_extend_free_slots);
        ...
        adapter= new extend_free_slot_adapter(this,slotData,exitTime,ExtraCharge,bookingId);
