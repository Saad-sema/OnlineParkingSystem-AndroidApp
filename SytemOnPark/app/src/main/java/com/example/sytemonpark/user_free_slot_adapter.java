...
public class user_free_slot_adapter extends BaseAdapter {
    ...
    public user_free_slot_adapter(Context context,ArrayList<HashMap<String, String>> slotList,String exitTime,Integer ExtraCharge,String bookingId) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.user_free_slot, parent, false);
                        ...
                        if (status.equals("updated")) {
                            ...
                            new AlertDialog.Builder(context)
                                    ...
                                    .setPositiveButton("Done", (dialog, which) -> {
                                        Intent intent = new Intent(context,User_Your_Booking_page.class);
